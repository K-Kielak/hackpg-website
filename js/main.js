;(function () {
	...
	// Animate Works
	var animateSchedule = function() {
		if ( $('.schedule').length > 0 ) {
			$('.schedule').each(function( k ) {
	...
	var animateSponsors = function() {
		if ( $('.sponsor-animate').length > 0 ) {
			$('.sponsor-animate').each(function( k ) {
	...
	var animateLocation = function() {
		if ( $('.location-animate').length > 0 ) {
			$('.location-animate').each(function( k ) {
		...
		if ($('#faq').length > 0 ) {
			$('#faq').waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					...
					setTimeout(function(){
						$('.faq-animate').addClass('fadeInUp animated');
					}, 100);
	...
	var scheduleWayPoint = function() {
		if ($('#schedule').length > 0 ) {
			$('#schedule').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {

					setTimeout( animateSchedule , 200);
	...
	var sponsorsWayPoint = function() {
		if ($('#sponsors').length > 0 ) {
			$('#sponsors').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {

					setTimeout( animateSponsors , 200);
	...
	var locationWayPoint = function() {
		if ($('#location').length > 0 ) {
			$('#location').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {

					setTimeout( animateLocation , 200);
